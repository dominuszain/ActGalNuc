...
IN_MATCHED = os.path.join(DATA_DIR, "wise_matched.fits")
IN_SDSS = os.path.join(DATA_DIR, "sdss_sample_classified.fits")
...
def main():
    ...
    plot_wise(x, y, wise_agn, title="WISE Colour-Colour – Mateos+12 AGN Wedge",
              fname=os.path.join(OUT_DIR, "wise_diagram.pdf"))
