...
IN_FITS = os.path.join(DATA_DIR, "sdss_sample_sii.fits")
...
def main():
    ...
    if mask_ne.sum() > 20:
        plot_bpt_2d_map(
            ...
            fname=os.path.join(OUT_DIR, "bpt_density_map.pdf"),
            log_norm=True,
        )
    ...
    if mask_sig.sum() > 20:
        plot_bpt_2d_map(
            ...
            fname=os.path.join(OUT_DIR, "bpt_sigma_map.pdf"),
            log_norm=False,
        )
    ...
    if mask_mbh.sum() > 10:
        plot_histogram(
            ...
            fname=os.path.join(OUT_DIR, "mbh_histogram.pdf"),
        )
        ...
        if "bpt_kewley" in tbl.colnames:
            ...
            plot_histogram_by_class(
                ...
                fname=os.path.join(OUT_DIR, "mbh_by_class_histogram.pdf"),
            )
        ...
        try:
            ...
            for i in range(len(bins) - 1):
                ...
                plot_bpt_2d_map(
                    ...
                    fname=os.path.join(OUT_DIR, f"bpt_sigma_mbh_{lo}_{hi}.pdf"),
                    log_norm=False,
                )
